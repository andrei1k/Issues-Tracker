    ...
    return(
        <div className='home-div'>
            ...
            <div className='description'>
                <h2>Welcome to the homepage of the IssueTracker project!</h2>
                ...
                <p>Additionally, IssueTracker offers the ability to define a workflow - 
                ...
                With IssueTracker, you can review your projects, filter tasks by assignee or status, 
